    ...
    >
      ...
      {preview && !blocked && (
        <div className="flex flex-col gap-2">
          {cycle.type === "session" ? <>
            <p className="text-body text-primary">This removes the focus block and its recorded focus time.</p>
            {cycle.started && !cycle.finished && <p className="text-body text-secondary">The running timer will stop.</p>}
            {preview.tasks > 0 && <p className="text-body text-secondary">{preview.tasks} task{plural(preview.tasks)} inside this block will also be deleted.</p>}
          </> : <>
