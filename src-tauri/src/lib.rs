...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::cycles::create_day_plan,
            // tasks
            ...
            commands::settings::set_auto_carry_unfinished,
            commands::settings::set_show_later_count,
            ...
            commands::calendar_view::delete_day_focus_blocks,
            commands::calendar_view::clear_day_schedules,
